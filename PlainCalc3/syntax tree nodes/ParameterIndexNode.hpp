...
#ifndef ParameterIndexNode_hpp
#define ParameterIndexNode_hpp

#import "ASTNode.hpp"

class ParameterIndexNode : public ASTNode
{
public:
			ParameterIndexNode( unsigned int index )
				: _index( index ) {}
