...
#ifndef DoGetUserFuncName_h
#define DoGetUserFuncName_h

#import "Built-ins.hpp"
#import "SCalcState.hpp"
#import "MatchedText.hpp"

struct DoGetUserFuncName
{
	void	operator()( auto& ctx ) const
	{
		...
		state.paramsOfFuncBeingDefined.clear();
		state.suppressUserFuncEvaluation += 1;
		
		// Make sure this name is not the name of a built-in constant or
		// function.
